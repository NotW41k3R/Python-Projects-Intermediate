...
def search_password():
    ...
    try:
        ...
        if website in data:
            ...
            messagebox.showwarning("No Credentials Found",f"The credentials for {website} do not exist. Make sure you have not made a typo.")
    except FileNotFoundError:
        messagebox.showwarning("Warning","There's nothing to search yet. Save your first password to continue.")
...
website_entry = Entry(width=33,font=FONT_2)
website_entry.grid(row=1,column=1)
website_entry.focus()

search_button = Button(text="Search",font=FONT_2,command=search_password,width=8)
...
generate_button = Button(text="Generate",font=FONT_2,command=generate_password,width=8)
